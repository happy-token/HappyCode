...
> **战略方向** (2026-05-20 更新): HappyCode 不做 Agent 引擎(与 Codex/Cursor 竞争没有意义)，
> 定位在 **AI Coding 工具链的桌面伴侣 + 企业治理层**。
> Codex Desktop 是闭源的，HappyCode 是唯一能看到源码的 AI Coding 桌面 GUI。
> 详见 [Codex 对比分析](./docs/CODEX_COMPARISON.md)。

## 优先级

| 优先级 | 方向 | 理由 |
|--------|------|------|
| P0 | 企业审计 + 合规 | Codex/Cursor/Copilot 全都没做，是空白市场 |
| P1 | 补基础 (测试/性能/错误边界) | 当前测试覆盖 ~8%，需要到 50%+ |
| P2 | 团队协作 (审计中台 + IM) | 不开源竞品无法提供的差异化 |

以下为已规划但尚未排期的功能方向，按上述优先级重新排列。
